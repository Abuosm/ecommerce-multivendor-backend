...
public class SellerServiceImpl implements SellerService {
	...
	public Seller updateSeller(Long id, Seller seller) throws SellerException {
		...
		if (seller.getBankDetails() != null
			...
			existingSeller.getBankDetails().setAccountHolderNumber(
	...
	public Seller updateSellerAccountStatus(Long sellerId, com.abubakar.domain.AccountStatus status) throws SellerException {
